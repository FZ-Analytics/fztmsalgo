...
//                ps.setString(2, "NEW");
    ...
    public List<HashMap<String, String>> getCustCombi(String branch, String runId) throws Exception {
        ...
        int x = 0;
        //while (x == 0) {
            String sql = "DECLARE @tcust AS TABLE\n" +
                    "	(\n" +
                    ...
                    "	INTO\n" +
                    "		@tcust SELECT\n" +
                    "			distinct concat('DEPO_', a.branch) as cust,\n" +
                    "			a.startLon AS lon,\n" +
                    "			a.startLat AS lat\n" +
                    "		FROM\n" +
                    ...
                    " DELETE\n" +
                    "FROM\n" +
                    "	BOSNET1.dbo.TMS_CostDistCombination;\n" +
                    ...
                    "INSERT\n" +
                    "	INTO\n" +
                    "		BOSNET1.dbo.TMS_CostDistCombination SELECT\n" +
                    "			*\n" +
                    "		FROM\n" +
                    "			@zcust";
    ...
    public List<HashMap<String, String>> getCustCombination() throws Exception {
        ...
        String sql = "SELECT\n"
                + "	cc.*\n"
                + "FROM\n"
                + "	BOSNET1.dbo.TMS_CostDistCombination cc\n"
